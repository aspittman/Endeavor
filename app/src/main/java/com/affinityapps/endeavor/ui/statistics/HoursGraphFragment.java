...
import com.affinityapps.endeavor.databinding.FragmentHoursGraphBinding;
...
public class HoursGraphFragment extends Fragment {
    private FragmentHoursGraphBinding binding;

    public HoursGraphFragment() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        binding = FragmentHoursGraphBinding.inflate(inflater, container, false);
        View root = binding.getRoot();

        BarChart barChart = binding.hoursBarChart;
        ...
        barChart.getDescription().setText("Hours Graph :D");
